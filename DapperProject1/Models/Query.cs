    ...
    public class Query
    {
            ...
            var values = new Dictionary<string, string>
        {
            ...
            using (var client = new HttpClient(new HttpClientHandler { AutomaticDecompression = DecompressionMethods.GZip | DecompressionMethods.Deflate }))
            {
               ...
               File.WriteAllLines(Directory.GetCurrentDirectory() + @"" + Path.DirectorySeparatorChar + "Queries" + Path.DirectorySeparatorChar + "Full_Json_Data5.txt", resultString);
        ...
        {
            HttpResponseMessage response = cl.GetAsync("https://www.italki.com/api/teachers?_r=1494330569181&country=&hl=uk-UA&i_token=TkRBNE5EQTNNZz09fDE0OTQzMzA1NTJ8ODQ5YTNhZTExZjM0OWFjMTNmY2I4OTQxNmM5MDQxNzQzOTk1ZGQwZg%3D%3D&is_instant=&page=" + count + "&price_usd=&speak=&teach=english&teacher_type=1").Result;
